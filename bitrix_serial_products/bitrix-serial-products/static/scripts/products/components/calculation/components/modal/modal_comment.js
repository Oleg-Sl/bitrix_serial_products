...
export default class ModalCommentView {
    constructor(eventEmitter) {
        ...
        this.commentFixedCell = this.modal.querySelector('.calculation-fixed');
        this.initHanlers();
    }
    ...
    render(comment, commentFixed, isEdit = false) {
        this.commentCell.value = comment;
        this.commentCell.disabled = !isEdit;
        this.commentFixedCell.value = commentFixed;
        this.commentFixedCell.title = commentFixed;
    }
}
