...
export default class FabricManager {
    constructor(fabricService, productService, callbackOutputImage) {
        ...
        this.select_1 = document.querySelector(`#upholsteryFabricCollection_3`);
        this.fabric_1 = new Fabric(this.fabricService, this.productService, this.select_1, 'upholsteryFabricCollection_3', 0, this.callbackOutputImage);
    }
