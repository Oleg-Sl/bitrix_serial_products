...
export const FIELD_COEFFICIENTS_FOT = {
    ...
    sketch: {
        baseSalaryRate: "ufCrm91_1755418946",           // Эскиз - Базовая ставка ЗП, руб
        baseTimeToProduce: "ufCrm91_1755419041",        // Эскиз - Базовая время изготовления изделия, час
        baseRatePerUnit: "ufCrm91_1755418989",          // Эскиз - Базовая ставка за ед. измерения изделия , руб
        costPerHour: "ufCrm91_1755419020"               // Эскиз - стоимость часа, руб
    },
};
