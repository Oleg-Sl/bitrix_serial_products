...
export default class DataService {
    constructor(apiClient, calcTypeId, calcFieldsAliases, productTypeId, productId, fabricManager) {
        ...
        this.fotService = null;
        this.userService = null;
        this.materialsService = null;
        this.coefficientsService = null;
        this.coefficientsFotService = null;
        this.checklistcomplexityService = null;
    }
    ...
    async init() {
        ...
        this.fotService = new FotService(fot);
        this.userService = new UserService(users, currentUser);
        this.materialsService = new MaterialsService(materials);
        this.coefficientsService = new CoefficientsService(coefficients);
        this.coefficientsFotService = new CoefficientsFotService(coefficientsfot);
        this.checklistcomplexityService = new ChecklistComplexityService(checklistcomplexity);
        this.calculationsService = new CalculationsService(calculations, calculationFields, this.calcFieldsAliases);
    ...
    async fetchData() {
        ...
        const coefficientsfot = response?.result?.coefficientsfot?.items?.[0] || {};
